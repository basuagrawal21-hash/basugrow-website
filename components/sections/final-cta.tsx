...
export function FinalCta() {
  ...
  return (
    <section className="bg-night text-bone relative isolate overflow-hidden py-[var(--spacing-section)]">
      <CursorGlow size={560} opacity={0.08} />
      ...
      <div className="container-page relative z-10">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="text-bone/70 mx-auto mt-6 max-w-xl text-[length:var(--text-base)]">
            A 20-minute call. We look at your offer, your market and what you are spending now, and
            give you a realistic range for what your budget could produce. No deck, no pressure, and
            we will say so if we are not the right fit.
          </p>
